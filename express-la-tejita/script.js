// Express La Tejita — armador de pedido por WhatsApp
// JS vanilla, sin dependencias.

(function () {
  'use strict';

  var WA_NUMBER = '50661033702';
  var WA_BASE = 'Hola, Express La Tejita, quiero hacer un pedido:';
  ...
  function render() {
    ...
    if (!hasItems) {
      summary.innerHTML = '<li class="empty">Sin items todavía — elija algo del menú.</li>';
